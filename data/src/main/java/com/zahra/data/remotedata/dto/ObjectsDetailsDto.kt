...
data class ObjectsDetailsDto(
    ...
    @SerializedName("additionalImages"      ) val additionalImages      : List<String>?      = null,
    @SerializedName("constituents"          ) val constituents          : List<ConstituentsDto>?= null,
    ...
    @SerializedName("tags"                  ) val tags                  : List<TagsDto>?        = null,
